...
Это программное обеспечение защищено строгой лицензией. Любое использование, копирование, модификация или распространение запрещено без письменного разрешения правообладателя.
...
См. файл [LICENSE](LICENSE) для подробных условий использования.
