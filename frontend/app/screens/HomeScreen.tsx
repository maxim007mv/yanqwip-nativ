...
export default function HomeScreen() {
  ...
  const popularOpacity = scrollY.interpolate({
    inputRange: [100, 200, 300],
    outputRange: [0.8, 0.95, 1],
    extrapolate: 'clamp',
  });

  const popularTranslateY = scrollY.interpolate({
    inputRange: [100, 200, 300],
    outputRange: [10, 5, 0],
    extrapolate: 'clamp',
  });

  const trendsOpacity = scrollY.interpolate({
    inputRange: [250, 350, 450],
    outputRange: [0.8, 0.95, 1],
    extrapolate: 'clamp',
  });

  const trendsTranslateY = scrollY.interpolate({
    inputRange: [250, 350, 450],
    outputRange: [10, 5, 0],
    extrapolate: 'clamp',
  });

  const routesOpacity = scrollY.interpolate({
    inputRange: [400, 500, 600],
    outputRange: [0.8, 0.95, 1],
    extrapolate: 'clamp',
  });

  const routesTranslateY = scrollY.interpolate({
    inputRange: [400, 500, 600],
    outputRange: [10, 5, 0],
    extrapolate: 'clamp',
  });
          ...
          <ScreenShell>
            ...
            <Animated.View
              style={[
                styles.section,
                {
                  opacity: popularOpacity,
                  transform: [{ translateY: popularTranslateY }],
                },
              ]}
            >
              <Text
            ...
            <Animated.View
              style={[
                styles.section,
                {
                  opacity: trendsOpacity,
                  transform: [{ translateY: trendsTranslateY }],
                },
              ]}
            >
              <Text
            ...
            <Animated.View
              style={[
                styles.section,
                {
                  ...
                  transform: [{ translateY: routesTranslateY }],
                },
              ]}
            >
              <Text
